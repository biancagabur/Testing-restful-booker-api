...
public class StepDefinition {
    ...
    public void iSendAPOSTRequestToWithAValidRequestBody(String endpoint) throws IOException {
        String requestBody = FileHelper.readFromFile("validTokenGenerationRequest.json");
        response = given()
    ...
    public void iSendAPOSTRequestToWithTheAnInvalidRequestBody(String endpoint) throws IOException {
        String requestBody = FileHelper.readFromFile("invalidTokenGenerationRequest.json");
        response = given()
                .contentType(ContentType.JSON)
                .body(requestBody)
                .when()
